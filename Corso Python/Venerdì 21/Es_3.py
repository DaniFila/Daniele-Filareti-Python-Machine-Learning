        ...
        if d == "1":
            ...
            for i in range(a,z+1):
                ...
                if Primo:
                    ...
                    Primo = True                     #in base alla scelta si scandisce il range e si verifica numero per volta, scandendo ogni numero a sua volta e se divide un numero diverso da 1 e se stesso non sarà primo
        elif d == "0":
            Primo = True
            for i in range(a,z+1):
                for j in range(2,i):
