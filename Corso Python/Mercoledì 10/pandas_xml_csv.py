...
# dataframe = pd.DataFrame(dati,index,columns)
...
#df.to_csv("Corso Python/Mercoledì 10/csv_pandas.csv",index=False)

df = pd.read_csv("Corso Python/Mercoledì 10/csv_pandas.csv")
